...
export default function Settings() {
  ...
  return (
    <div className="max-w-2xl">
      <h2 className="text-2xl font-bold text-slate-800 dark:text-slate-100 mb-4">Settings</h2>

      <div className="bg-white dark:bg-slate-800 dark:border-slate-700 rounded-xl border border-slate-200 p-6 shadow-sm mb-6">
        <h3 className="font-semibold text-slate-800 dark:text-slate-100 mb-1">Appearance</h3>
        <p className="text-xs text-slate-500 dark:text-slate-400 mb-4">Choose how the app looks on this device.</p>
        <div className="flex items-center justify-between gap-4 py-2">
          <div>
            <p className="text-sm font-medium text-slate-800 dark:text-slate-100">Dark mode</p>
            <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
              {theme === "dark" ? "Currently on." : "Currently off."} This is saved on this device, per person.
            </p>
          </div>
