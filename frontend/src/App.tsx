...
import EmergencyScheduler from "./pages/EmergencyScheduler";
...
export default function App() {
  ...
  return (
    <Routes>
      ...
      <Route
        path="/settings"
        element={<ProtectedRoute allow={["ADMIN"]}><Layout><Settings /></Layout></ProtectedRoute>}
      />
      <Route
        path="/emergency"
        element={<ProtectedRoute allow={["ADMIN"]}><Layout><EmergencyScheduler /></Layout></ProtectedRoute>}
      />
    </Routes>
  );
}
